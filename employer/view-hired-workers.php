								...
								<div class="table-responsive">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											$email = $_SESSION['email'];
												$sql = "SELECT * , hire_employee.id as hid FROM (hire_employee JOIN service_portfolio ON hire_employee.servicePortfolioId = service_portfolio.id) JOIN employee ON hire_employee.employeeEmail = employee.emailAddress WHERE hire_employee.employerEmail = '$email' order by hireTime desc";
