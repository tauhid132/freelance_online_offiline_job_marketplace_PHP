								...
								<li>
									<div class="lang-icon dropdown">
										...
										<div class="dropdown-menu lanuage-dropdown dropdown-menu-left">
											<a href="bn/" class="link-item" href="#"><img src="images/flagbd.svg" style="height: 20px; width: 20px; float: left; margin-right: 5px;">   বাংলা</a>
									...
									<div class="account order-1 dropdown">
										<a href="#" class="account-link dropdown-toggle-no-caret" role="button" data-toggle="dropdown">
											...
											if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
												...
												echo '<i class="fa fa-sign-in"></i> <span class=""> LOGIN / SIGN UP</span>';
											}else{
												echo '
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						<nav class="navbar navbar-expand-lg navbar-light bg-dark1 justify-content-sm-start">
							...
							<div class="collapse navbar-collapse d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-end bg-dark1 p-3 p-lg-0 mt1-5 mt-lg-0 mobileMenu" id="navbarSupportedContent">
								<ul class="navbar-nav align-self-stretch">
									...
									<li class="nav-item dropdown">
										<a href="services.php" class="nav-link dropdown-toggle-no-caret" role="button" data-toggle="dropdown">Find Services</a>
							...
							<form action="#" method="get" class="search-form" style="margin-top:10px">
								...
								<!-- <a href="post_a_job.html" class="add-post">LOGIN</a> -->
							</nav>
