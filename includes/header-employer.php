							...
							<ul>
								<li class="dropdown">
									...
									<div class="dropdown-menu message-dropdown dropdown-menu-right">
										...
										$output = ''; 
										$sql7 = "SELECT * FROM employee WHERE emailAddress IN ((SELECT senderEmail FROM messages WHERE receiverEmail = '$email') UNION (SELECT receiverEmail FROM messages WHERE senderEmail = '$email'))";
										if($result7 = mysqli_query($conn, $sql7)){
											if(mysqli_num_rows($result7) > 0){
												while($row = mysqli_fetch_array($result7)){
													...
													$result4=mysqli_fetch_array($query2); 
													...
													<span>'.$result4['text'].'</span>
													</a>
													</div>
													<div class="time5">'.$result4['timestamp'].'</div>
													</div>
													</div>';
										...
										<div class="user-request-list">
											<a href="<?php echo $url ?>/employer/view-messages.php" class="view-all">View All Messages</a>
										</div>
									</div>
								</li>
								<li class="dropdown">
									...
									<div class="dropdown-menu message-dropdown dropdown-menu-right">
										...
										?>
										<div class="user-request-list">
											<a href="<?php echo $url ?>/employer/notifications.php" class="view-all">View All Notifications</a>
										</div>
									</div>
								</li>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<nav class="navbar navbar-expand-lg navbar-light bg-dark1 justify-content-sm-start">
							...
							<div class="collapse navbar-collapse d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-end bg-dark1 p-3 p-lg-0 mt1-5 mt-lg-0 mobileMenu" id="navbarSupportedContent">
								<ul class="navbar-nav align-self-stretch">
									...
									<li class="nav-item dropdown">
										<a href="services.php" class="nav-link dropdown-toggle-no-caret" r>Find Services</a>
										
									</li>
									<li class="nav-item dropdown">
										<a href="faq.php" class="nav-link dropdown-toggle-no-caret" role="button" data-toggle="dropdown">FAQ</a>
							...
							<form action="#" method="get" class="search-form" style="margin-top:10px">
