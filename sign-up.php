...
if(isset($_POST['submit'])){
	...
	if($_POST['type'] == 1){
		mysqli_query($conn, "INSERT INTO employer (emailAddress,password, fullName) VALUES ('$email','$passwordN','$fullName')");
		header("location: login.php");
	}else if($_POST['type']==0){
		mysqli_query($conn, "INSERT INTO employee (emailAddress,password, fullName) VALUES ('$email','$passwordN','$fullName')");
		header("location: login.php");
	}
				...
				<div class="col-md-6">
					<div class="lg_form">
						...
						<div class="form-group">
							...
							<span class="error-message" id="email_address_error">  Please choose another email.</span>
						</div>
						<div class="form-group">
						...
						<button class="lr_btn" type="submit" name="submit" onclick="window.location.href = 'sign-up.php';">Sign Up Now</button>
						<div class="done145">
							<div class="done146">
