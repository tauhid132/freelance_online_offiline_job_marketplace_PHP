		...
		<div class="container">
			<div class="row">
							...
							<ul>
								...
								<li>
									<div class="job_dt_1">
										...
										<span>Intermediate (10 year - 12 year)</span>
									</div>
								</li>
				...
				<div class="col-lg-3 col-md-4 mainpage">
					...
					<button class="apply_job_rt2" type="submit" data-toggle="modal" data-target="#applyjobModal"><i class="fa fa-times-circle"></i> Decline</button>
