...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
      <h1 class="text-danger"><i class="fa fa-user-times"></i> Expired Users </h1>
      <ol class="breadcrumb">
        <li><a href="#">Users</a></li>
        <li><i class="fa fa-angle-right"></i> Expired Users</li>
      </ol>
    </div>
...
// Attempt select query execution
            $sql = "SELECT * FROM users WHERE status='Expired'";
