<?php
			...
			include_once('includes/routeros_api.class.php');			
			include_once('includes/connapi.php');
                                    ...
                                    <tbody>
												...
												<?php
													...
													echo "<tr>";
														...
														echo "<td><a href='pppoe_online_kick.php?user=".$i."'><center><img src='../img/kick.png' width=20px title=Kick></a></td>";
													echo "</tr>";
													}
												?>
