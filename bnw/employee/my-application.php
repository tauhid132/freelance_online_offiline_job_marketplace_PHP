								...
								<div class="table-responsive">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											...
											$email = $_SESSION['email'];
											$sql = "SELECT * FROM (apply_job join job_posts ON apply_job.jobPostId = job_posts.id) join employer on job_posts.email = employer.emailAddress join service_portfolio on apply_job.serviceId = service_portfolio.id WHERE apply_job.applicantEmail = '$email'";
