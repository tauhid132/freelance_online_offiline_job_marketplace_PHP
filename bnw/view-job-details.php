				...
				<div class="col-lg-9 col-md-8 mt-20">
					...
					<div class="job-item ptrl_2 mt-20 ">
						<div class="view_chart_header">
							...
							<h4 class="rating_header" style="float:right; font-size: 25px;"><i class="fas fa-star"></i> 4.0 / 5.0</h4>
						</div>
						
						<ul class="all_applied_jobs jobs_bookmarks">
							<?php
							$sql = "SELECT * FROM hire_employee Join employer on hire_employee.employerEmail = employer.emailAddress WHERE servicePortfolioId = '$portfolio_id'";
