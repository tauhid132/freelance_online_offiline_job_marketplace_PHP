...
$job_id = $_GET['job-id'];
$query2=mysqli_query($conn,"SELECT * FROM hire_employee join employee on hire_employee.employeeEmail = employee.emailAddress join service_portfolio on hire_employee.servicePortfolioId = service_portfolio.id where hire_employee.id = '$job_id'");
					...
					<div class="dsh150">
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									<center>
										<button class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-send-sms"><i class="fa f fa-share-square-o"></i> Make Payment</button>
