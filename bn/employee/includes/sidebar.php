...
$sqlForRating = "SELECT * FROM hire_employee where employeeEmail = '$email'";
if($resultForRating = mysqli_query($conn, $sqlForRating)){
  if(mysqli_num_rows($resultForRating) > 0){ 
    while($rowForRating = mysqli_fetch_array($resultForRating)){
      $rating = $rating + $rowForRating['jobRating'];
    }
    $rating = round($rating / mysqli_num_rows($resultForRating));
  } 
  ...
  <div class="account_dt_left">
    <div class="job-center-dt">
      ...
      <div class="job-urs-dts">
        ...
        ?>
        <a href="personal-information.php"><button class="btn btn-info btn-sm"><i class="fa fa-user"></i> My Profile Info</button></a>
        <div class="mt-20">
        <span class="label label-success">Employee Profile</span>
        </div>
    ...
    <div class="my_websites">
      <ul>
        ...
        <li><a href="#" class="web_link"><i class="fas fa-mobile-alt"></i><?php echo $result['mobileNo']?></a></li>
      </ul>
    </div>
    ...
    <div class="rlt_section">
      ...
      <div class="rtl_right">
        <div class="star">
          ...
          <span><?php echo round($rating) ?></span>
        </div>
      </div>
    </div>
    <div class="rlt_section">
