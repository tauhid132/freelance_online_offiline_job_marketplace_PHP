...
$countService = mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) FROM service_portfolio")); 
$countHire = mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) FROM hire_employee"));
$countJob = mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) FROM job_posts"));
$countApp = mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) FROM apply_job"));
$countOffers = mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) FROM job_offers"));
$countCom = mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) FROM hire_employee WHERE jobStatus = 2"));
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          <div class="info-box"> <span class="info-box-icon bg-aqua"><i class="fa fa-users"></i></span>
            <div class="info-box-content"> <span class="info-box-number"><?php echo $countEmployer[0] ?></span> <span class="info-box-text">Total Employers</span> </div>
            <!-- /.info-box-content --> 
          </div>
          <!-- /.info-box --> 
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="info-box"> <span class="info-box-icon bg-green"><i class="fa fa-users"></i></span>
            <div class="info-box-content"> <span class="info-box-number"><?php echo $countEmployee[0] ?></span> <span class="info-box-text">Total Employee</span></div>
            <!-- /.info-box-content --> 
          </div>
          <!-- /.info-box --> 
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="info-box"> <span class="info-box-icon bg-yellow"><i class="fa fa-users"></i></span>
            <div class="info-box-content"> <span class="info-box-number"><?php echo $countService[0] ?></span> <span class="info-box-text">Total Services</span></div>
            <!-- /.info-box-content --> 
          </div>
          <!-- /.info-box --> 
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="info-box"> <span class="info-box-icon bg-red"><i class="fa fa-money"></i></span>
            <div class="info-box-content"> <span class="info-box-number"><?php echo $countJob[0] ?></span> <span class="info-box-text">Total Job Posts</span></div>
            <!-- /.info-box-content --> 
          </div>
          <!-- /.info-box --> 
        </div>
              ...
              <div class="col-lg-3 col-sm-6 col-xs-12">
                <div> <i class="fa fa-user-plus f-20 text-blue"></i>
                  <div class="info-box-content">
                    <h1 class="f-25 text-black"><?php echo $countApp[0] ?></h1>
                    <span class="progress-description">Total Application</span> </div>
                    <div class="progress">
                ...
                <div class="col-lg-3 col-sm-6 col-xs-12">
                  <div> <i class="fa fa-user-times f-20 text-danger"></i>
                    <div class="info-box-content">
                      <h1 class="f-25 text-black"><?php echo $countOffers[0] ?></h1>
                      <span class="progress-description">Total Job Offers</span> </div>
                      <div class="progress">
                  ...
                  <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div> <i class="fa fa-users f-20 text-info"></i>
                      <div class="info-box-content">
                        <h1 class="f-25 text-black"><?php echo $countHire[0] ?></h1>
                        <span class="progress-description">Total Hired</span> </div>
                        <div class="progress">
                    ...
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                      <div> <i class="ti-wallet f-20 text-green"></i>
                        <div class="info-box-content">
                          <h1 class="f-25 text-black"><?php echo $countCom[0] ?></h1>
                          <span class="progress-description">Total Completed Jobs</span> </div>
                          <div class="progress">
