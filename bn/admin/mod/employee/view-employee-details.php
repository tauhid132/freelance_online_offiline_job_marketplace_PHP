...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="card">
      <div class="card-body">
        <center>
          <button class="btn btn-primary" data-toggle="modal" data-target="#modal-billing-history"><i class="fa fa-eye"></i> View Services</button>
          <button class="btn btn-success" data-toggle="modal" data-target="#modal-ticket-history"><i class="fa fa-eye"></i> View Works</button>
          <button class="btn btn-info" data-toggle="modal" data-target="#modal-send-sms"><i class="fa fa-paper-plane"></i> View Applications</button>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Service Portfolio</h4>
