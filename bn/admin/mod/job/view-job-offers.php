...
<head>
  ...
  <title>View Job Offers | <?php echo $siteName; ?></title>
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
     <h1><i class="fa fa-users"></i> Job Offers List</h1>
      ...
      <div class="table-responsive">
        <table id="example1" class="table table-bordered table-striped">
         ...
         <tbody>
          ...
          $sql = "SELECT *, employer.fullName as afn, employer.imageLink as ail, employee.fullName as bfn, employee.imageLink as bil, job_offers.status jstatus  from job_offers join employer on employer.emailAddress = job_offers.offeredBy join service_portfolio on service_portfolio.id = job_offers.serviceId join employee on service_portfolio.employee_email = employee.emailAddress";
