...
<head>
  ...
  <title>Employers | <?php echo $siteName; ?></title>
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content-header sty-one">
     <h1><i class="fa fa-users"></i> Employers Management</h1>
          ...
          if($result = mysqli_query($conn, $sql)){
            if(mysqli_num_rows($result) > 0){
              ...
              while($row = mysqli_fetch_array($result)){
                ...
                <a href="view-employer-details.php?id=' . $row['id'] . '">

                <button class="btn btn-sm btn-info"><i class="fa fa-eye"></i> View</button>
                </a>
                <a href="action/delete-employee.php?id=' . $row['id'] . '">
