		...
		<div class="container">
											...
											if($result7 = mysqli_query($conn, $sql7)){
												if(mysqli_num_rows($result7) > 0){
													while($row = mysqli_fetch_array($result7)){
														...
														$query2=mysqli_query($conn,"SELECT * FROM messages WHERE (receiverEmail = '$email' and senderEmail = '$sender') or (receiverEmail = '$sender' and senderEmail = '$email') order by timestamp desc LIMIT 1;");
			...
			<script type="text/javascript">
				...
				$(document).ready(function(){
					...
					var ifGet = '<?php echo $ifGet; ?>';
					if(ifGet == 1){
						globalReceiver = '<?php echo $receiverphp; ?>';
						//globalReceiver = globalReceiver2;
						$.ajax({  
					...
					function showMessage(messageHTML) {
						...
						$(document).ready(function(){
							var websocket = new WebSocket("ws://103.132.154.31:8090/demo/php-socket.php"); 
