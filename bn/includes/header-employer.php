				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="top-header-full">
						<div class="top-left-hd">
							<ul>
								<li><div class="wlcm-text">ভাষা</div></li>
								<li>
									<div class="lang-icon dropdown">
										<img src="images/flagbd.svg" style="height: 20px; width: 20px; float: left; margin-right: 5px;">
										<a href="#" class="icon15 dropdown-toggle-no-caret" role="button" data-toggle="dropdown">
											বাংলা <i class="fas fa-caret-down p-crt"></i>
										</a>
								...
								<li class="dropdown">
									...
									<div class="dropdown-menu message-dropdown dropdown-menu-right">
										...
										<div class="user-request-list">
											সকল মেসেজ দেখুন <a href="<?php echo $url ?>/employee/view-messages.php" class="view-all"></a>
										</div>
									</div>
								</li>
								<li class="dropdown">
									...
									<div class="dropdown-menu message-dropdown dropdown-menu-right">
										...
										<div class="user-request-list">
											<a href="hospital_notifications.html" class="view-all">সকল নোটিফিকেশান
দেখুন											</a>
										</div>
									</div>
								</li>
									...
									<div class="account order-1 dropdown">
										<a href="#" class="account-link dropdown-toggle-no-caret" role="button" data-toggle="dropdown">
											...
											if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
												...
												<a class="link-item" href="'.$url.'/employer/view-messages.php"><i class="fa fa-envelope-o"></i> Messages</a>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<nav class="navbar navbar-expand-lg navbar-light bg-dark1 justify-content-sm-start">
							<a class="order-1 order-lg-0 ml-lg-0 ml-3 mr-auto" href="index.php"><img src="<?php echo $url ?>/images/lg/logo_final.png" style="height: 60px;"  alt=""></a>
							...
							<div class="collapse navbar-collapse d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-end bg-dark1 p-3 p-lg-0 mt1-5 mt-lg-0 mobileMenu" id="navbarSupportedContent">
								<ul class="navbar-nav align-self-stretch">
									<li class="nav-item active">
										<a class="nav-link" href="<?php echo $url ?>/index.php">হোম <span class="sr-only">(current)</span></a>
									</li>
									<li class="nav-item dropdown">
										<a href="#" class="nav-link dropdown-toggle-no-caret" role="button" data-toggle="dropdown">সার্ভিস সমুহ
										</a>
									...
									<li class="nav-item dropdown">
										<a href="#" class="nav-link dropdown-toggle-no-caret" role="button" data-toggle="dropdown">ব্লগপোস্ট</a>
										<div class="dropdown-menu pages-dropdown">
