											...
											<div class="row">
												...
												<div class="col-lg-6">
													<div class="form-group">
														...
														<input type="text" class="job-input" name="profession" value="<?php echo $result['profession']?>">
													</div>
												</div>
												<div class="col-lg-12">
													<div class="form-group">
														<label class="label15">Profile BIO</label>
														<textarea class="note-input" name="intro" ><?php echo $result['intro']?></textarea>
													</div>
												</div>
												<div class="col-lg-6">
													<div class="form-group">
